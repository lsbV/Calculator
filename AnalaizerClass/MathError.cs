...
namespace AnalaizerClass
{
    public static class MathError
    {
        ...
        public static string Error02 { get; } = "Error 02 at <i> — Невідомий оператор на <i> символі.";
        public static string Error03 { get; } = "Error 03 — Невірна синтаксична конструкція вхідного виразу.";
